/**
 * Created by Volkan on 23.3.2016.
 */
exports.result = function(req, res){

    var from = selectNode(req.body['from']);
    var to = selectNode(req.body['to']);
    ...
    function astarSearch(node,target){
        ...
        for(var i=0;i<node.leafs.length;i++){
            if(selectNode(node.leafs[i].node).selected == 0){
                ...
                //Eger baska yoldan oraya daha az cost gelinmiş ise wic degis
